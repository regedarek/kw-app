class Db::User < ActiveRecord::Base
  ...
  ROLES = %w(reservations routes admin events courses competitions office tech donations photo_competition management secondary_management financial_management)
