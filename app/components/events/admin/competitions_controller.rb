    ...
    class CompetitionsController < ::Admin::BaseController
      ...
      def competition_params
        params
          .require(:competition)
          .permit(
            :name, :results_url, :edition_sym, :rules, :baner, :single, :team_name, :event_date, :accept_first, :rules_text, :sign_up_starts_at, :weekend_nights,
            ...
            :organizer_email, :info_above_sign_ups, package_types_attributes: [:id, :membership, :name, :junior_year, :cost, :_destroy]
          )
      end
    end
  end
