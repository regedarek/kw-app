module Strzelecki
  class SignUpForm
    ...
    attr_accessor :name_1, :vege_1, :birth_year_1, :organization_1, :city_1, :email_1, :package_type_1, :phone_1, :gender_1, :tshirt_size_1,
                  :name_2, :vege_2, :birth_year_2, :organization_2, :city_2, :email_2, :package_type_2, :phone_2, :gender_2, :tshirt_size_2,
                  :single, :remarks, :terms_of_service

    validates :name_1, :birth_year_1, :package_type_1, :email_1, :gender_1, :tshirt_size_1,
      presence: true
    validates :name_2, :birth_year_2, :vege_2, :package_type_2, :gender_2, :tshirt_size_2,
    ...
    def params
      HashWithIndifferentAccess.new(
        name_1: name_1, vege_1: vege_1, birth_year_1: birth_year_1, package_type_1: package_type_1, tshirt_size_1: tshirt_size_1,
        name_2: name_2, vege_2: vege_2, birth_year_2: birth_year_2, package_type_2: package_type_2, tshirt_size_2: tshirt_size_2,
