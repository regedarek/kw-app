    ...
    class CoursesController < ApplicationController
      ...
      def course_params
        params
          .require(:course)
          .permit(
            :name, :payment_type, :slug, :place, :start_date, :kind, :end_date, :application_date, :price_kw, :baner, :email_remarks, :question,
            :price_non_kw, :remarks, :category, :price, :one_day, :active, :cash, :expired_hours, :reserve_list, :baner_type, :state, :send_manually,
