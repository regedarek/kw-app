  ...
  class PaymentsController < ApplicationController
    ...
    def charge
      ...
      result.success do |payment_url:|
        ...
        redirect_to payment_url, alert: 'Stworzono link do płatności', allow_other_host: true
      end
      ...
      result.dotpay_request_error do |message:|
        if Rails.env.development?
          ...
          redirect_to payment.payment_url, alert: 'Stworzono link do płatności', allow_other_host: true
        else
