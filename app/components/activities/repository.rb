module Activities
  class Repository
    ...
    def fetch_season(route_type = 'regular_climbing', start_date=DateTime.new(2020, 07, 1), end_date=DateTime.new(2020, 11, 30))
    ...
    def start_date
      start_date = DateTime.new(2020, 07, 1)
    end

    def end_date
      end_date = DateTime.new(2019, 11, 30)
    end
  end
end
