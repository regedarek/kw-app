module Strzelecki
  class SignUpForm
    ...
    validates :name_1, :birth_year_1, :category_type, :package_type_1, :email_1, :phone_1,
      presence: true
    validates :name_2, :birth_year_2, :vege_2, :package_type_2, :phone_2 ,presence: true, if: :team?
