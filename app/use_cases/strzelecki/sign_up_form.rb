module Strzelecki
  class SignUpForm
    ...
    attr_accessor :name_1, :vege_1, :birth_year_1, :organization_1, :city_1, :email_1, :package_type_1,
                  :name_2, :vege_2, :birth_year_2, :organization_2, :city_2, :email_2, :package_type_2,
                  :single, :category_type, :remarks

    validates :name_1, :birth_year_1, :category_type, :package_type_1, :email_1,
      presence: true
    validates :name_2, :birth_year_2, :vege_2, :package_type_2, presence: true, if: :team?
